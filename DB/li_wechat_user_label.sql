...
-- ----------------------------
-- Table structure for li_wechat_user_label
-- ----------------------------
DROP TABLE IF EXISTS `li_wechat_user_label`;
CREATE TABLE `li_wechat_user_label`  (
  ...
  `count` int NULL DEFAULT NULL COMMENT '标签粉丝数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of li_wechat_user_label
-- ----------------------------
INSERT INTO `li_wechat_user_label` VALUES (2, 'SYSTEM', '2022-06-02 09:29:21.547000', b'0', NULL, NULL, '星标组', 0);
