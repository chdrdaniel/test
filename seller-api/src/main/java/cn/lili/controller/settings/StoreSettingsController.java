...
public class StoreSettingsController {
    ...
    @ApiOperation(value = "修改店铺发票设置")
    @PutMapping("/receipt")
    public ResultMessage<Object> editStoreReceiptSetting(@Valid StoreReceiptSettingDTO storeReceiptSettingDTO) {
        boolean result = storeDetailService.editStoreReceiptSetting(storeReceiptSettingDTO);
        return ResultUtil.data(result);
    }
}
